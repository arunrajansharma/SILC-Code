...
static const yytype_uint8 yyprhs[] =
{
      ...
      32,    36,    40,    44,    48,    52,    55,    59,    61
};

/* YYRHS -- A `-1'-separated list of the rules' RHS.  */
static const yytype_int8 yyrhs[] =
{
      22,     0,    -1,    23,    -1,    24,    -1,    24,    25,    -1,
      -1,    14,    13,    26,     4,    -1,    11,    19,    14,    20,
       4,    -1,    12,    19,    26,    20,     4,    -1,    26,     5,
      26,    -1,    26,     6,    26,    -1,    26,     7,    26,    -1,
      26,    10,    26,    -1,    26,     8,    26,    -1,    19,    26,
      20,    -1,     6,    26,    -1,    26,     9,    26,    -1,     3,
      -1,    14,    -1
};
...
{
       0,    89,    89,   101,   104,   109,   112,   114,   116,   119,
...
static const char *const yytname[] =
{
  ...
  "R", "READ", "WRITE", "ASSIGN_OP", "ID", "LT", "GT", "EQ", "UMINUS",
  "'('", "')'", "$accept", "start", "program", "stmts", "stmt", "expr", 0
};
#endif
...
{
     -12,    10,   -12,   -10,   -12,    20,    21,    28,   -12,    23,
       3,     3,    22,   -12,     3,   -12,     3,    18,    41,    39,
     -12,    24,     3,     3,     3,     3,     3,     3,    48,   -12,
     -12,   -12,    11,    11,    -2,    -2,    26,    43,   -12
};
...
{
      18,     5,     6,    20,     7,    21,    13,    26,    27,    14,
       4,    32,    33,    34,    35,    36,    37,    15,    24,    25,
      26,    27,    16,    22,    23,    24,    25,    26,    27,    22,
      23,    24,    25,    26,    27,    -1,    27,    12,    28,     9,
      10,    11,    19,    30,    31,    29,    22,    23,    24,    25,
      26,    27,    38,    -1
};
...
{
      11,    11,    12,    14,    14,    16,     3,     9,    10,     6,
       0,    22,    23,    24,    25,    26,    27,    14,     7,     8,
       9,    10,    19,     5,     6,     7,     8,     9,    10,     5,
       6,     7,     8,     9,    10,     9,    10,    14,    20,    19,
      19,    13,    20,     4,    20,     4,     5,     6,     7,     8,
       9,    10,     4,    10
};
...
{
       0,    22,    23,    24,     0,    11,    12,    14,    25,    19,
      19,    13,    14,     3,     6,    14,    19,    26,    26,    20,
      26,    26,     5,     6,     7,     8,     9,    10,    20,     4,
       4,    20,    26,    26,    26,    26,    26,    26,     4
};
